...
<body style="background: #cc3700;">

	<!-- background="pg/image/background/welcome.jpg" -->
	<nav class="navbar navbar-inverse" style="background-color: black; font-size: medium; border-radius:0px; -webkit-border-radius:0px; -moz-border-radius:0px;"> <!-- <nav class="navbar navbar-inverse" style="background:transparent;font-size: low; border-radius:0px; -webkit-border-radius:0px; -moz-border-radius:0px;"> -->
		...
		<div ng-app="myApp" ng-controller="formCtrl">
			<form id="signIn" novalidate ng-submit="registerForm()" style="display: none;">
				...
				<div class="input-group form-group">
					<span class="input-group-addon"> <span class="glyphicon glyphicon-envelope">E</span>
